...
function ProductCard({ productData, loading, error, navigation,status }) {
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.9}
      onPress={() => navigation.navigate('ProductDescription', { productData: productData,status:status })}
          ...
          <View style={styles.valueRow}>
            <View style={styles.valueTextContainer}>
              <TextDefault style={[styles.text, styles.headerText]}>
                {productData.amountWeight.Weight} grams
              </TextDefault>
            </View>
            <View style={styles.valueTextContainer}>
              <TextDefault style={[styles.text, styles.headerText]}>
                {productData.amountWeight.Amount} ₹
              </TextDefault>
            </View>
          </View>
        </View>
        ...
        <View style={styles.bottomSection}>
          ...
          <View style={styles.dateContainer}>
            ...
            <TextDefault style={styles.dateText}>
              {new Date(productData.maturityDate).toLocaleDateString('en-GB', {
                day: '2-digit',
                month: 'short',
                year: 'numeric',
              })}
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('ProductDescription', { product: productData })}>
