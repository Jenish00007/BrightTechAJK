...
const SchemePassbook = ({ navigation, route }) => {
  const { product ,status} = route.params;  // Extract product from route.params
...
const transactionHistory = [
  {
    status: status,
    date: product.joindate,  // Use joindate as the starting transaction date
    weight: product.amountWeight.Weight || 0,  // Use the Weight from amountWeight
